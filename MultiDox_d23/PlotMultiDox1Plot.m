...
xlabel('Time (hours)','FontSize',15); ylabel('Fluorescence (RFU)','FontSize',15); 
...
xlabel('Dox level in ng/ul','FontSize',15); ylabel('Fluorescence (RFU)','FontSize',15); 
saveas(2,'DoxVsProteinIFFL.jpg'); 
save('e:\UWPhDWork\ModelFittingIFFL\d23params','Dox','pVal'); 
...
xlabel('Time (hours)','FontSize',15); ylabel('mRNA no.','FontSize',15); 
legend('Dox-666','Dox-800','Dox-1000','Dox-1500','Dox-2000','Dox-2500','Dox-5000','Dox-15000','Dox-1000000','Location','BestOutside'); 
